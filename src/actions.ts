...
export function authSignIn(user: string, image: string): AuthSignIn {
    return {
        type: "AUTH_SIGN_IN",
        user,
        image
...
export function authSignOut(): AuthSignOut {
    return {
        type: "AUTH_SIGN_OUT"
    };
}
...
// ----------------------------------------------------------------------------
export interface AuthAwaiting {
    readonly type: "AUTH_AWAITING";
}
export function authAwaiting(): AuthAwaiting {
    return {
        type: "AUTH_AWAITING"
    };
}
